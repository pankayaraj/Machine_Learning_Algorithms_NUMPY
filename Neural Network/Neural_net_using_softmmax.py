# Neural network using softmax as a output activation function and cross entropy as cost function for classification
...
class neuralnet:
    ...
    def neural ( self, dataset, actual_ys, learning_rate, no_of_iterations):
            ...
            for i in range(len(dataset)):
                ...
                for j in range(self.theta_len):
                    ...
                    for k in range(len(t)):
                        ...
                        w_t_n = w_t_n + learning_rate*e*in_
                        w_t_n = w_t_n.tolist()
...
A = neuralnet( 3, [2,2], 3)
c = A.neural ( [[0,0,0,1]], [[0,0,1]], 1, 100)
print (c)
